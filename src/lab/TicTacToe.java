...
import java. util. Scanner; 
	public class TicTacToe {
	  public  static char[][] board =  new char[3][3];// Tic-tac-toe board
	   public static Scanner sc = new Scanner(System.in); // Scanner for getting input from the user
	    static char currentPlayer = sc.next().charAt(0); // Current player (X or O)
